...
public class ScoreBoard {
	...
	/**
	 * TODO Find out why this is called nudge - check
	 */
	...
	/**
	 * Saves this ScoreBoard to the config
	 */
	protected void save() {
	...
	/**
	 * Gets the headers for the different stats to post belonging to that gameMode
	 * 
	 * @param gameMode
	 * @return
	 */
	...
	/**
	 * Gets all signs to locate the ScoreBoard
	 * 
	 * @param loc
	 * @param gameMode
	 * @return
	...
	/**
	 * Gets all signs to complete the ScoreBoard
	 * 
	 * @param b
	 * @return
	 */
	...
	/**
	 * Delete the config for this ScoreBoard
	 * 
	 * @param id -Board id
	 */
	...
	/**
	 * Saves the config for this ScoreBoard
	 * 
	 * @param config
	 */
